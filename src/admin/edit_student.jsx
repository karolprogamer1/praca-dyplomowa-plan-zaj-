...
export default function EditStudent({ style, title = 'Edytuj studenta', student, formData = {}, status = {}, classes = [], onChange, onCancel, onSave }) {
      ...
      <div className="student-plan-card admin-form-card">
        <div className="plan-header">
          <div>
            ...
            <h1>{title}</h1>
            <p className="plan-subtitle">Zmień dane studenta i zapisz.</p>
        ...
        <form className="admin-student-form" onSubmit={handleSubmit}>
          ...
          <label>
            ...
            <small style={{ color: '#666' }}>Przypisanie do zajęć jest wymagane, aby student widział swój plan.</small>
          </label>
