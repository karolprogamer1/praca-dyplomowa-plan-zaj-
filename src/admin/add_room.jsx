...
export default function AddRoom({ style, title = 'Dodaj salę', formData = {}, status = {}, onChange, onCancel, onSave }) {
      ...
      <div className="student-plan-card admin-form-card">
        <div className="plan-header">
          <div>
            ...
            <h1>{title}</h1>
            <p className="plan-subtitle">Wypełnij formularz, aby zapisać salę.</p>
          </div>
        </div>
